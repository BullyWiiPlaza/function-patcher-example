...
static void KernelReadDBATs(bat_table_t *table) {
	...
	asm volatile("mfspr %0, 536" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 537" : "=r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mfspr %0, 538" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 539" : "=r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mfspr %0, 540" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 541" : "=r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mfspr %0, 542" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 543" : "=r" (table->bat[batIndex].l));
	batIndex++;

	asm volatile("mfspr %0, 568" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 569" : "=r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mfspr %0, 570" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 571" : "=r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mfspr %0, 572" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 573" : "=r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mfspr %0, 574" : "=r" (table->bat[batIndex].h));
	asm volatile("mfspr %0, 575" : "=r" (table->bat[batIndex].l));
}
...
static void KernelWriteDBATs(bat_table_t *table) {
	...
	asm volatile("mtspr 536, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 537, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mtspr 538, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 539, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mtspr 540, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 541, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mtspr 542, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 543, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;

	asm volatile("mtspr 568, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 569, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mtspr 570, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 571, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mtspr 572, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 573, %0" : : "r" (table->bat[batIndex].l));
	batIndex++;
	asm volatile("mtspr 574, %0" : : "r" (table->bat[batIndex].h));
	asm volatile("mtspr 575, %0" : : "r" (table->bat[batIndex].l));
